  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 bg-linear-to-b from-black/40 via-black/30 to-black/10" />
        <h1 className="absolute z-20 text-white text-3xl text-center md:text-6xl tracking-widest font-primary uppercase top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          {title}
        </h1>
    </Section>
  );
