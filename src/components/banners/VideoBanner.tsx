...
const VideoBanner: React.FC<VideoBannerProps> = ({
  ...
  return (
    <Section
      ...
      className="relative w-full lg:aspect-16/7.56 aspect-video "
    >
      ...
      <div className="absolute inset-0 z-10 bg-linear-to-b from-black/40 via-black/30 to-black/10" />
        <h1 className="absolute z-20 text-white text-4xl md:text-6xl tracking-widest font-primary uppercase top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          {title}
        </h1>
    </Section>
  );
