...
export default function ViewSection() {
  ...
  return (
    <SectionWithContainer sectionClassName="bg-secondary py-24">
        ...
        <div className="relative h-screen overflow-hidden">
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center px-6 text-center">
            <div className="max-w-[700px]">
              ...
              <h2 className="font-primary mt-6 text-4xl font-light  text-white md:text-6xl">
              ...
              <p className="mx-auto mt-6 max-w-[520px] text-base text-white/80">
